...
test-integration:
	...
	$(ENV) && dart run test/integration/s3_test_connection_test.dart
	$(ENV) && dart run test/integration/s3_list_objects_test.dart
	$(ENV) && dart run test/integration/s3_get_object_test.dart
